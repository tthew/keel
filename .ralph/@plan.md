...
- [ ] Story 1.4 Task 2 — ATDD probes (AC 2/3/4 commit-abort + AC 5 clean-commit + AC 6 prek-runner parity); capture evidence in Debug Log ~medium
...
- **Story:** 1.4 — Pre-commit quality gates via prek (type-check, lint, format) — **ready-for-dev** (Task 1 done)
