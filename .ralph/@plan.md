...
- **PR:** #230 Open, isDraft=false, MERGEABLE. 9 unresolved Round-2 threads remain post-FIX-7 (A2, A3, A5, A6, A7, C1, D1-D3); A1+A4+A8 closing-threads queued for sweep iter.
