...
## QUEUE (Story 1.9 — CR re-run #3 outcome processed: Fix F landed iter-22; Fix G + CR re-run #4 remain)
...
- **iter-22 Fix F landed.** Story 1.9 stays `fixes-pending`. One MEDIUM fix remains (Fix G) before CR re-run #4. Sprint-status + story-file Status unchanged (`review`).
