...
# run ralph.py plan`. Story 2.7's original `docker attach` design assumed
...
#
# Extra arguments are passed through to ralph.py (e.g. `pnpm ralph:plan
# --iterations 3`, `pnpm ralph:plan --debug`).
#
