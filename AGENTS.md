...
- **Operator override:** `KEEL_DEVBOX_CONTAINER_NAME` is respected in per-fork mode (Story 2.1 collision path); **INTENTIONALLY IGNORED in shared mode** (shared is opinionated — both forks must attach to the same container name for AC 2).
